...
S.MobilePhoto = styled.div`
  ...
  shape-outside: circle(50% at 100%) border-box;
  shape-margin: 10px;
  margin-right: -20px;
...
S.VerticalSpacing = styled.div`
  margin-bottom: ${props => props.size * 10}px;
`;

S.VerticalSpacing.propTypes = {
  size: PropTypes.number.isRequired,
};

const AboutMeIntro = () => (
  <p>
    I'm passionate about creating beautiful user interfaces which rigorously conform to
    <em> web standards</em> whilst being <em>responsive</em> and <em>accessible</em>.
  </p>
);
      ...
      <S.About>
        <MobileOnly>
          ...
          <S.Content>
            ...
            <S.VerticalSpacing size={2} />

            <Button onClick={() => setShowAboutMe(true)}>Learn more about me</Button>
          </S.Content>
        </MobileOnly>
